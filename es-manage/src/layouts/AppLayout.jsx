                          ...
                          {decodedToken["Show Brand"] && (
                            <li>
                              <Link to="/brand" className="dropdown-item">
                                ...
                                <span className="icon-text">Brand</span>
                              </Link>
                            </li>
                          )}
                          ...
                          {decodedToken["Show Item Supplier"] && (
                            <li>
                              <Link to="/item-supplier" className="dropdown-item">
                                ...
                                <span className="icon-text">Item Supplier</span>
                              </Link>
                            </li>
                          )}
                          {decodedToken["Show Item Supplier Transaction"] && (
                            <li>
                              <Link to="/item-supplier-transaction" className="dropdown-item">
                                <span className="nav-link-icon d-md-none d-lg-inline-block">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="16" width="20" viewBox="0 0 640 512">
                                ...
                                <span className="icon-text">Item Supplier Transaction</span>
                              </Link>
                            </li>
                          )}
                        </ul>
                          ...
                          {decodedToken["Show Role"] && (
                            <li>
                              <Link to="/role" className="dropdown-item">
                                ...
                                <span className="icon-text">Role</span>
                              </Link>
                            </li>
                          )}
                        </ul>
